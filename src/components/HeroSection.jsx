  ...
  return (
        <section id="Inicio" className="container container-xs my-5 py-5" >
            <div className="row espacioR">
                <div className="col-xs-12 col-lg-5 d-flex flex-column justify-content-end align-items-start mb-5 ps-0">
                ...
                <div className="col col-lg-7 col-xs-12">
                    ...
                    <img src="./images/Pres.png" alt="Foto perfil" className="imagen" />
                </div>
            </div>
        </section>
  )
